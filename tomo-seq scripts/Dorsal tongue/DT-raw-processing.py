...
for i, df in enumerate([dfs_g1,dfs_g2]):
    plt.subplot(2,4,i+1)
    plt.bar(range(len(df[-1].columns)), df[-1].sum()/1e6, color = '#E7298A')
...
for i, df in enumerate([dfs_g1,dfs_g2]):
    plt.subplot(2, 4, i + 5)
    plt.bar(range(len(df[-1].columns)), (df[-1] > 0).sum()/1e3, color = '#E7298A')
...
plt.savefig(path + 'QC_DT.pdf', bbox_inches = 'tight')
plt.show()

writer = pd.ExcelWriter(path + '/QC_DT.xlsx')
for i, df in enumerate([dfs_g1,dfs_g2]):
    (df[-1]>0).sum().to_excel(writer, sheet_name = 'num_genes, DT '+str(i+1))
    df[-1].sum().to_excel(writer, sheet_name = 'num_trans, DT ' + str(i+1))
writer.close()
...
plt.subplot(141)
plt.bar(range(len(nfdfs[0].columns)), nfdfs[0].loc[g], color = '#E7298A'); plt.title('DT1, Cdh1')
plt.subplot(142)
plt.bar(range(len(nfdfs[1].columns)), nfdfs[1].loc[g], color = '#E7298A'); plt.title('DT2, Cdh1')
plt.savefig(path + 'Cdh1_DT.pdf', bbox_inches = 'tight')
plt.show()

g = 'ENSMUSG00000045545_Krt14_ProteinCoding__11' # [idx for idx in dfu_g1[0].index if 'BRCA1' in idx]
plt.figure(figsize=(14,3))
plt.subplot(141)
plt.bar(range(len(nfdfs[0].columns)), nfdfs[0].loc[g], color = '#E7298A'); plt.title('DT1, Krt14')
plt.subplot(142)
plt.bar(range(len(nfdfs[1].columns)), nfdfs[1].loc[g], color = '#E7298A'); plt.title('DT2, Krt14')
plt.savefig(path + 'Krt14_DT.pdf', bbox_inches = 'tight')
plt.show()

g = 'ENSMUSG00000026728_Vim_ProteinCoding__2' # [idx for idx in dfu_g1[0].index if 'BRCA1' in idx]
plt.figure(figsize=(14,3))
plt.subplot(141)
plt.bar(range(len(nfdfs[0].columns)), nfdfs[0].loc[g], color = '#E7298A'); plt.title('DT1, Vim')
plt.subplot(142)
plt.bar(range(len(nfdfs[1].columns)), nfdfs[1].loc[g], color = '#E7298A'); plt.title('DT2, Vim')
plt.savefig(path + 'Vim_DT.pdf', bbox_inches = 'tight')
plt.show()

g = 'ENSMUSG00000018830_Myh11_ProteinCoding__16' # [idx for idx in dfu_g1[0].index if 'BRCA1' in idx]
plt.figure(figsize=(14,3))
plt.subplot(141)
plt.bar(range(len(nfdfs[0].columns)), nfdfs[0].loc[g], color = '#E7298A'); plt.title('DT1, Myh11')
plt.subplot(142)
plt.bar(range(len(nfdfs[1].columns)), nfdfs[1].loc[g], color = '#E7298A'); plt.title('DT2, Myh11')
plt.savefig(path + 'Myh11_DT.pdf', bbox_inches = 'tight')
plt.show()
...
savedfs(fdfs_g1, path + '/DT1')
savedfs(fdfs_g2, path + '/DT2')
